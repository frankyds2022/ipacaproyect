                    ...
                    <div className="flex flex-col md:flex-row gap-16 items-center">
                        ...
                        <div className="md:w-1/2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-8">
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-3 sm:p-4 rounded-2xl border border-slate-100 dark:border-slate-700 flex items-center gap-3 sm:gap-4 shadow-sm hover:shadow-md transition">
                                    <div className="bg-primary/10 dark:bg-primary-light/20 p-2.5 sm:p-3 rounded-xl text-primary dark:text-primary-light flex-shrink-0">
                                        <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                                    </div>
                                    <span className="text-slate-800 dark:text-slate-200 font-bold font-outfit text-sm sm:text-base leading-tight">Asesores <br /><span className="text-xs sm:text-sm font-normal text-slate-500 dark:text-slate-400">Colegiados</span></span>
                                </div>
                                <div className="bg-slate-50 dark:bg-slate-800/50 p-3 sm:p-4 rounded-2xl border border-slate-100 dark:border-slate-700 flex items-center gap-3 sm:gap-4 shadow-sm hover:shadow-md transition">
                                    <div className="bg-accent/10 dark:bg-accent/20 p-2.5 sm:p-3 rounded-xl text-accent flex-shrink-0">
                                        <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                                    </div>
                                    <span className="text-slate-800 dark:text-slate-200 font-bold font-outfit text-sm sm:text-base leading-tight">Gestión <br /><span className="text-xs sm:text-sm font-normal text-slate-500 dark:text-slate-400">Transparente</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
